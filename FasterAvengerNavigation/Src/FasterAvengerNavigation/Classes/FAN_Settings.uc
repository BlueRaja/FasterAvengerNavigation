class FAN_Settings extends UIScreenListener config(StartingStaff_Settings);
...
`include(FasterAvengerNavigation/Src/ModConfigMenuAPI/MCM_API_Includes.uci)
`include(FasterAvengerNavigation/Src/ModConfigMenuAPI/MCM_API_CfgHelpers.uci)
`MCM_CH_VersionChecker(class'FAN_Settings_Defaults'.default.ConfigVersion, ConfigVersion)
...
{
    AvatarPauseMultiplier = `MCM_CH_GetValue(class'FAN_Settings_Defaults'.default.AvatarPauseMultiplier, AvatarPauseMultiplier);
    InstantRoomTransitions = `MCM_CH_GetValue(class'FAN_Settings_Defaults'.default.InstantRoomTransitions, InstantRoomTransitions);
    SkipHologlobeDissolveAnimation = `MCM_CH_GetValue(class'FAN_Settings_Defaults'.default.SkipHologlobeDissolveAnimation, SkipHologlobeDissolveAnimation);
}
